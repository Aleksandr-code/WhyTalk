...
// const ROOM_ID = '123';
let userName;
if(document.querySelector('.user__name')){
  userName = document.querySelector('.user__name').textContent.trim()
} else {
...
const inviteButton = document.querySelector('.room-page__block-invite').addEventListener('click', () =>{
  prompt(
    "Для подключения к конференции перейдите по ссылке ниже",
